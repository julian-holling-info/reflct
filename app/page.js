...
import { Book, Sparkles, Lock, Calendar, ChevronRight, BarChart2, FileText } from "lucide-react";
  ...
  return (
    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
            ...
            <div className="bg-white rounded-2xl  p-4 max-full mx-auto">
                ...
                <div className="space-y-4 p-4">
                    <h3 className="text-xl font-semibold text-orange-900">
                        {advice ? advice : "Nothing to advise"}
                    </h3>
      ...
      <div className="space-y-24 mt-24">
        ...
        {/* Testimonials */ }
        <TestimonialCarousel />   {/*  <-- Server Component */ }
          ...
          <Card className="bg-gradient-to-r from-orange-100 to-amber-100">
              <CardContent className="p-12 text-center">
                  ...
                  <p className="text-lg text-orange-700 mb-8 max-w-2xl mx-auto">
                      Join thousands of writers who have already discovered the power of digital journalling
                  </p>
                  <Link href="/dashboard">
